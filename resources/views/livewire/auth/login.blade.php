...
<div class="mx-2">
    <div class="flex mt-8 border sm:mx-auto sm:w-full sm:max-w-7xl">
        <div class="items-center hidden w-6/12 px-4 lg:flex">
            <img src="{{ asset('asset/undraw_goal_-0-v5v.svg') }}" alt="">
        </div>
        <div class="w-full bg-white lg:w-6/12">
            <form wire:submit='authenticate' class="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24">
                <h4 class="w-full text-3xl font-bold">Connexion</h4>
                <div class="relative w-full mt-10 space-y-8">
                    ...
                    <div class="relative">
                        <button type="submit"
                            ...
                            data-primary="blue-600" data-rounded="rounded-lg">Connexion</button>
                    </div>
                </div>
            </form>
        </div>
