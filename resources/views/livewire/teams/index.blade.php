        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
            @foreach ($teams as $item)
                <div
                    ...
                    <div class="relative pb-6 p-7 w-[25rem]">
                        <p class="mt-12 mb-6 text-neutral-500 text-">{{ $item->slogan }}</p>
