            ...
            @foreach ($teams as $item)
                <div
                    ...
                    <div class="absolute top-0 z-50 flex items-center w-full mt-2 translate-y-24 px-7 -translate-x-0">
                        ...
                        <button wire:click="addFollowers('{{ $item->id }}')"
                    ...
                    <div class="relative pb-6 p-7">
                        ...
                        <div class="flex items-center justify-between pr-2 text-neutral-500">
                            ...
                            <a href="https://twitter.com/adamwathan/followers"
                                class="text-sm hover:underline"><strong
                                    class="text-neutral-800">{{ $item->followers ?? 0 }}</strong>
                                Followers</a>
                        </div>
                    </div>
                </div>
